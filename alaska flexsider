    ...
    $.flexslider = function (t, a) {
        ...
        $.data(t, "flexslider", n), f = {
            init: function () {
                ...
                }), n.vars.pauseInvisible && f.pauseInvisible.isHidden() || (n.vars.initDelay > 0 ? n.startTimeout = setTimeout(n.play, n.vars.initDelay) : n.play())), m && f.asNav.setup(), r && n.vars.touch && f.touch(), (!p || p && n.vars.smoothHeight) && $(window).bind("resize orientationchange focus", f.resize), n.find(".slides img").attr("draggable", "false"), setTimeout(function () {
                    n.vars.start(n)
                }, 200)
            },
            asNav: {
            ...
            controlNav: {
                ...
                setupPaging: function () {
                    ...
                    n.controlsContainer ? $(n.controlsContainer).append(n.controlNavScaffold) : n.append(n.controlNavScaffold), f.controlNav.set(), f.controlNav.active(), n.controlNavScaffold.delegate(".slides a, .slides img", o, function (e) {
                ...
                set: function () {
                    var e = "thumbnails" === n.vars.controlNav ? ".slides img" : "a";
